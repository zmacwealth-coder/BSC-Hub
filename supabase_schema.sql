-- Supabase PostgreSQL Relational Schema DDL Script
-- Institution: Bright Success College
-- Designed for Multi-Role School Management & Results Hub

-- Enable necessary extensions
create extension if not exists "uuid-ossp";

-- Clean existing entities (Cascaded)
...
-- Basic Policies allowing reads/writes for authenticated accounts.
-- Note: Service-role operations (such as seeding) bypass these rules natively.
